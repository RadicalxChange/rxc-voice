...
class TransferSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        sender_data = validated_data.get('recipient')
        ...
        recipient_data.update(credit_balance=(recipient_data.credit_balance + validated_data.get('amount')))
        sender_data.update(credit_balance=(sender_data.credit_balance - validated_data.get('amount')))
        return transfer
